...
public class FrontControllerServletV5 extends HttpServlet {
    ...
    public FrontControllerServletV5(@MyHandler Map<String, Object> handlerMappingMap, List<MyHandlerAdapter> handlerAdapters) {
    ...
    private MyHandlerAdapter getHandlerAdapter(Object handler) {
        ...
        System.out.println("handlerAdapters = " + handlerAdapters);
